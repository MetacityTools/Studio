import { IconProps as AIconProps, Icon } from "@adobe/react-spectrum";
import { SVGProps } from "react";

type IconProps = Omit<AIconProps, "children"> & {
...
export function TriangleEmpty(props: IconProps) {
  const { transform, ...rest } = props;
  return (
    <Icon {...rest}>
      <svg
      ...
      >
        ...
        <path
          fill="none"
          d="M 6.667 16.345 C 6.667 16.345 7.254 18.203 7.254 18.209 C 7.254 18.215 16.812 18.323 16.812 18.323 L 17.348 15.947 L 12.631 7.449 L 11.036 7.572"
        />
      </svg>
    </Icon>
  );
