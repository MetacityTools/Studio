import * as GL from 'bananagl';
import React from 'react';
import { IFCLoaderData } from 'types';

import { Container } from '@components/Elements/Container';

import Worker from '@workers/Grid.worker?worker';
import { getTransferable } from '@workers/IFC/transform';
...
export function ModelParser() {
    ...
    const handleModelParsed = (model: IFCLoaderData) => {
        ...
        const transferables = getTransferable(model.data);
        worker.postMessage(model, transferables);
    };
