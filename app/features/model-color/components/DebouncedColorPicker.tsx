import { Color, ColorEditor, ColorPicker, parseColor } from "@react-spectrum/color";
...
export default function DebouncedColorPicker({ value, onChange }: DebouncedColorPickerProps) {
